# Generated by Django 4.0.3 on 2022-12-23 17:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sitio_web', models.CharField(default='Sitio web', max_length=20, null=True, verbose_name='sitio web')),
                ('instagram_redsocial', models.CharField(default='Instagram', max_length=20, null=True, verbose_name='instagram')),
                ('tiktok_redsocial', models.CharField(default='TikTok', max_length=20, null=True, verbose_name='tiktok')),
                ('facebook_redsocial', models.CharField(default='Facebook', max_length=20, null=True, verbose_name='facebook')),
        ...
        migrations.CreateModel(
            name='Historial_Created_admin',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('log', models.CharField(max_length=300, verbose_name='Nuevo evento')),
                ('eventoid', models.CharField(max_length=300, verbose_name='Id del tipo de evento creado')),
                ('fecha', models.DateTimeField(default=datetime.datetime(2022, 12, 23, 14, 44, 56, 519257))),
            ],
        ),
        migrations.CreateModel(
            name='Historial_Created_user',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('log', models.CharField(max_length=300, verbose_name='Nuevo evento')),
                ('eventoid', models.CharField(max_length=300, null=True, verbose_name='Id del tipo de evento creado')),
                ('userid', models.PositiveIntegerField(null=True, verbose_name='Id del usuario qu crea')),
                ('fecha', models.DateTimeField(default=datetime.datetime(2022, 12, 23, 14, 44, 56, 520256))),
            ],
        ),
        migrations.CreateModel(
            name='Historial_delete_admin',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tiktok_redsocial', models.CharField(default='TikTok', max_length=20, null=True, verbose_name='tiktok')),
                ('facebook_redsocial', models.CharField(default='Facebook', max_length=20, null=True, verbose_name='facebook')),
                ('correo_contacto', models.EmailField(max_length=254, verbose_name='Correo contacto')),
                ('correo_sugerencias_reclamos', models.EmailField(max_length=254, verbose_name='Correo sugerencias y reclamos')),
            ],
        ),
        migrations.CreateModel(
            name='Matricula',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reserva', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='myclasses.reserva_estado', verbose_name='Id de reserva que reserva')),
            ],
        ),
        migrations.CreateModel(
            name='Planes',
