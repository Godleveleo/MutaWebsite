# Generated by Django 3.2.13 on 2022-11-12 03:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reserva', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myclasses.reserva_estado', verbose_name='Id de reserva que reserva')),
            ],
        ),
        migrations.CreateModel(
            name='Perfil',
